...
export const PERMS_PADRAO = {
  viewer: {
    ...
    verDocumentos:false, iniciarRevisao:false, tornarObsoleto:false, configurarDocumentos:false, baixarArquivoFonte:false, baixarCopiaNaoControlada:false, gerenciarTreinamento:false,
  ...
  user: {
    ...
    verDocumentos:true, iniciarRevisao:false, tornarObsoleto:false, configurarDocumentos:false, baixarArquivoFonte:false, baixarCopiaNaoControlada:false, gerenciarTreinamento:false,
  ...
  rt: {
    ...
    verDocumentos:true, iniciarRevisao:true, tornarObsoleto:false, configurarDocumentos:true, baixarArquivoFonte:true, baixarCopiaNaoControlada:true, gerenciarTreinamento:false,
  ...
  keyuser: {
    ...
    verDocumentos:true, iniciarRevisao:true, tornarObsoleto:true, configurarDocumentos:true, baixarArquivoFonte:true, baixarCopiaNaoControlada:true, gerenciarTreinamento:false,
  ...
  admin: {
    ...
    verCQMateriais:true, criarMaterialCQ:true, lancarAnalise:true, aprovarAnalise:true, editarAnalise:true, verLaudos:true, criarLaudos:true,
    criarDocumento:true, assinarElaborador:true, assinarRevisorAprovador:true, excluirDocumento:true, registrarTreinamento:true,
    verDocumentos:true, iniciarRevisao:true, tornarObsoleto:true, configurarDocumentos:true, baixarArquivoFonte:true, baixarCopiaNaoControlada:true, gerenciarTreinamento:true,
    editarFornecedores:true, criarAuditorias:true, editarClientes:true, editarIPC:true, editarIPCProdutos:true,
  },
  exec: {
    criarRNC:false, editarRNCpropria:false, editarRNCtodas:false, analisarRNC:false, aprovarRNC:false, excluirRNC:false,
